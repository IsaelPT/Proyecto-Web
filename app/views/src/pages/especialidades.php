...
<html lang="es">
  ...
  <body class="bg-cover bg-center bg-fixed"
          ...
          <form method="POST" action="?controller=Especialidad&&action=guardar"
            ...
            <div class="mb-4 flex flex-col">
              ...
              <input name="detalles" type="text" id="especialidad" class="w-full p-3 border rounded"
                placeholder="Escriba el nombre de la especialidad" value="<?php echo $esp->getDescripcion() ?>"
                required>
    ...
    <a href="#footer"
      class="btn-flotante fixed bottom-16 right-4 bg-gray-500 text-white px-4 py-2 rounded shadow-lg text-sm sm:text-base">Información</a>
