...
<body class="bg-cover bg-center bg-fixed"
  style="background-image: linear-gradient(rgba(186, 172, 172, 0.542), rgba(205, 194, 194, 0.2)), url('app/views/src/icons/consulta.jpg');background-position: center 20%;">
  ...
  <main class="container mx-auto py-4 px-6 sm:px-6 max-w-full overflow-x-auto">
    <section class="mb-8">
      <div class="flex flex-col items-center">
        <h2 class="text-2xl sm:text-4xl font-bold mb-4">Añadir especialidad</h2>
        <form method="POST" action="?controller=Especialidad&&action=guardar"
          ...
          <div class="mb-4 flex flex-col">
            ...
            <input name="detalles" type="text" id="especialidad" class="w-full p-3 border rounded"
              placeholder="Escriba el nombre de la especialidad" value="<?php echo $esp->getDescripcion() ?>" required>
  ...
  <a href="#footer"
    class="btn-flotante fixed bottom-10 right-4 bg-gray-500 text-white px-4 py-2 rounded shadow-lg text-sm sm:text-base">Información</a>
