...
>>>>>>> 16bcc89 (Modified: Views conexiones con el backend.)
      ...
      <section class="mb-8">
        <div class="flex flex-col items-center mt-10">
          ...
          <table id="tablaPacientes"
            class="p-6 w-auto backdrop-blur-lg bg-gray-100/60 border-collapse overflow-hidden rounded-lg table-auto">
            <thead>
              <tr>
                  ...
                  <?php if ($i + 1 == count($especialidades)): ?>
                    ...
                    <td class="p-2 sm:p-3 border-gray-700 text-left">
                      <div class="flex flex-col sm:flex-row justify-end items-center space-y-2 sm:space-y-0 sm:space-x-4">
                        ...
                        <a href="?controller=Especialidad&&action=eliminar&&id=<?php echo $especialidades[$i]->id_especialidad ?>"
