  ...
  <main class="container mx-auto py-4 px-6 sm:px-6 max-w-full overflow-x-auto">
    <section class="mb-8">
      <div class="flex flex-col items-center mt-10">
        ...
        <form method="POST" action="?controller=Doctor&&action=guardar"
          ...
          <div class="mb-4 flex flex-col ">
            ...
            <input name="nombre_doctor" type="text" id="nombre" class="w-full p-3 border rounded"
              placeholder="Escriba el nombre" value="<?php echo $doc->getNombre_Doctor(); ?>" required>
          </div>
          <div class="mb-4 flex flex-col">
            <label for="apellidos" class="block text-dark-gray-text font-semibold mb-2">Apellidos</label>
            <div>
              <input name="primer_apellido_doctor" type="text" id="apellido_1" class="w-full p-3 border rounded mb-2"
                placeholder="Escriba el primer apellido" value="<?php echo $doc->getApellido_Doctor(); ?>" required>
            </div>
            <div class="mt-2">
              <input name="segundo_apellido_doctor" type="text" id="apellido_2" class="w-full p-3 border rounded"
                placeholder="Escriba el segundo apellido" value="<?php echo $doc->getSegApellido_Doctor(); ?>" required>
            </div>
          </div>
          <div class="mb-4 flex flex-col">
            <label for="especialidad_2" class="block text-dark-gray-text font-semibold mb-2">Especialidad</label>
            <select name="id_especialidad" id="especialidad_2" class="w-full p-3 border rounded mb-2" required>
              <option value="" disabled selected>Seleccione una especialidad</option>
              <?php foreach ($this->especializacion->listar() as $esp): ?>
                <option value="<?php echo $esp->id_especialidad ?>"><?php echo $esp->detalles ?></option>
              <?php endforeach ?>
            </select>
          </div>
