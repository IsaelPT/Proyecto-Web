...
<html lang="es">
    ...
    <body class="bg-cover bg-center bg-fixed" style="background-image:linear-gradient(rgba(186, 172, 172, 0.542), rgba(205, 194, 194, 0.2)), url('../../src/icons/pacients.jpg');">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <form class="bg-light-gray p-6 rounded-lg shadow-md w-full max-w-4xl backdrop-blur-lg bg-gray-100/60">
                        ...
                        <div class="mb-4 flex flex-col">
                            ...
                            <div>
                                <input type="text" id="apellido_1" class="w-full p-3 border rounded mb-2"placeholder="Escriba el primer apellido" required>
                            </div>
                            <div class="mt-2">
                                <input type="text" id="apellido_2" class="w-full p-3 border rounded" placeholder="Escriba el segundo apellido" required>
                            </div>
                        </div>
                        <div class="mb-4 flex flex-col">
                            <label for="seguro" class="block text-dark-gray-text font-semibold mb-2">Número de seguro social</label>
                            <input type="text" id="seguro" class="w-full p-3 border rounded"placeholder="Escriba el número de seguro social" required>
                        </div>
                        <div class="mb-4 flex flex-col">
                            <label for="diagnostico" class="block text-dark-gray-text font-semibold mb-2">Diagnóstico</label>
                            <input type="text" id="diagnostico" class="w-full p-3 border rounded"placeholder="Escriba el diagnóstico del paciente" required>
                        </div>
                        <div class="flex justify-end">
                            <button type="submit" class=" px-4 py-2 bg-green-300 text-black rounded hover:bg-green-500 mr-5">Guardar</button>
